  ...
  return (
    ...
    >
      ...
      <div className='absolute inset-0 overflow-hidden'>
        <div className='absolute -top-1/2 -right-1/2 w-[1000px] h-[1000px] rounded-full bg-gradient-to-br from-emerald-100/30 via-purple-100/30 to-blue-100/30 dark:from-emerald-900/20 dark:via-purple-900/20 dark:to-blue-900/20 blur-3xl animate-gradient'></div>
        <div className='absolute -bottom-1/2 -left-1/2 w-[1000px] h-[1000px] rounded-full bg-gradient-to-br from-blue-100/30 via-cyan-100/30 to-emerald-100/30 dark:from-blue-900/20 dark:via-cyan-900/20 dark:to-inemeralddigo-900/20 blur-3xl animate-gradient'></div>
      </div>

      <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32'>
        <div className='flex flex-col items-center text-center space-y-12'>
          {/* Animated badge */}
          <div className='inline-flex items-center px-3 py-1 rounded-full bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-100 dark:border-emerald-800 animate-fadeInUp [animation-delay:200ms]'>
            <Code2
              size={14}
          ...
          <div className='max-w-4xl space-y-6'>
            ...
            <p className='text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto animate-fadeInUp [animation-delay:600ms]'>
              Turning challenges into sleek, scalable web and mobile solutitns.
            </p>
          </div>
          ...
          <div className='flex flex-col sm:flex-row items-center gap-4 sm:gap-6 animate-fadeInUp [animation-delay:800ms]'>
            <a
              href='#projects'
              className='group flex items-center gap-2 px-8 py-4 bg-emerald-600 hover:bg-emerald-700 text-white rounded-full text-lg font-semibold transition-all duration-300 hover:gap-4 hover:scale-105'
            >
              View Projects
              <ArrowRight
